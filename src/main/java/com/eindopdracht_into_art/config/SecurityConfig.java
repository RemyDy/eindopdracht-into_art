package com.eindopdracht_into_art.config;

import com.eindopdracht_into_art.config.security.filters.JwtRequestFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeRequests(auth -> auth
                        .antMatchers(EP_NEWSLETTER, "/register/**", "/login/**", EP_HELLO).permitAll()
